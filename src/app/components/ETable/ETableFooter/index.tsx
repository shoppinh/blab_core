...
`;
const FooterButton = styled(EButton)`
...
const DisplayedText = styled.div`
  ...
  font-weight: 400;
`;
const LeftNavigationButton = styled(EButton)`
...
const RightNavigationButton = styled(EButton)`
  width: ${pxToRem(100)}rem;
  height: ${pxToRem(32)}rem;
  padding: ${pxToRem(5)}rem ${pxToRem(10)}rem;
...
const DTableFooter: React.FC<DTableFooterProps> = ({ range = [], setPage, page, slice }) => {
